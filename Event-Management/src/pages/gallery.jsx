...
const Gallery = () => {
  ...
  return (
    <div className="gallery-container">
        <div className="main">
      <h1 className="gallery-title">FROM CAMERA ROLL <br />
       TO A CURATED GALLERY</h1>
  </div>
 <div className="filter-controls">
  <div className="filter-group">
    ...
    >
      <option value="year" className="option">Academic Year</option>
      <option value="category" className="option">Category</option>
    </select>
  </div>
    ...
    >
      ...
      <div className="gallery-grid">
        {filteredData.map((item) => (
          <div className="gallery-card" key={item.id}   data-aos="fade-up">
            <img src={images[item.image]} alt={item.title} className="gallery-img" />
